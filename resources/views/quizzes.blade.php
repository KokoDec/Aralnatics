...
<body class="bg-gray-50 min-h-screen">
    ...
    <div id="sidebar" class="mobile-sidebar lg:translate-x-0 fixed inset-y-0 left-0 z-40 w-64 bg-white shadow-xl border-r border-gray-200">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            ...
            <a href="/quizzes" class="sidebar-item active flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 font-medium">
            ...
            <a href="/create-quiz" class="sidebar-item flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 font-medium">
